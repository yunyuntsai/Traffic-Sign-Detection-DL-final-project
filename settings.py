...
NUM_CLASSES = 10  # 2 signs + 1 background class
...
if MODEL == 'AlexNet':
	...
	IMG_H, IMG_W = 260, 400
	#
	FM_SIZES = [[32, 50], [8, 12], [4, 6], [2, 3]]
	FM_SIZES_VGG = [[31,48], [15,23], [8,12], [4,6]]
else:
...
MODEL_SAVE_PATH = './model2.ckpt'  # where to save trained model
